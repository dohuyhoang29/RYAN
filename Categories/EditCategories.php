        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-files-o"></i>Edit Categories</li>
            </ol>
          </div>
        </div>
                ...
                <div class="form">
                  <form action="<?php echo $_SERVER['PHP_SELF'] ?>" onsubmit="return isFormValidation();" class="form-validate form-horizontal " id="register_form" method="post">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class=" form-control" id="name" name="name" type="text" value="<?php echo isFormValidated() ? $categories['Name'] : $_POST['name'] ?>" />
  ...
  <script>
    function isFormValidation(){
      ...
      if(name == ''){
        ...
        document.getElementById('name').style.border = '1px solid #ceeced2';
        return true;
      }
